        ...
        <div class="w-full md:w-2/3">
            ...
            <div class="flex justify-center w-full mb-10">
                <div class="flex justify-center items-center gap-5 md:gap-8 bg-white/50 backdrop-blur-sm p-4 md:p-5 rounded-2xl border border-slate-100 shadow-sm w-fit">
                    ...
                    <div class="flex flex-col items-center text-center">
                        <span class="text-3xl md:text-4xl font-display font-extrabold text-slate-800">+15</span>
        ...
        <div class="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-200">
            <form action="<?= BASE_URL ?>/contact" method="POST" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <label for="name" class="flex items-center text-sm font-bold text-slate-700 mb-2">
                    ...
                    <div>
                        <label for="email" class="flex items-center text-sm font-bold text-slate-700 mb-2">
                ...
                <div>
                    <label for="subject" class="flex items-center text-sm font-bold text-slate-700 mb-2">
                ...
                <div>
                    <label for="content" class="flex items-center text-sm font-bold text-slate-700 mb-2">
                    ...
                    <textarea id="content" name="content" rows="6" required class="w-full px-5 py-4 rounded-xl border border-slate-200 focus:ring-2 focus:ring-brand focus:border-brand outline-none transition-all resize-y bg-slate-50 hover:bg-white focus:bg-white"></textarea>
                </div>
                ...
                <div class="pt-2 text-center md:text-right">
                    ...
                    render_button('Envoyer', 'submit', 'w-full sm:w-auto px-10 py-4 text-lg shadow-lg hover:shadow-xl hover:-translate-y-0.5 transform duration-200', $send_icon); 
                    ?>
                </div>
            </form>
        </div>
