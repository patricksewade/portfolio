 ...
 * Les données de CV et de projets statiques sont conservées ici (YAGNI : pas de DB pour ces données).
 */
final class HomeController
{
    ...
    /**
     * Affiche la page d'accueil avec les projets (statiques + BDD) et les données CV.
     */
    ...
    {
        return $this->viewRenderer->renderResponse('pages/mentions-legales.php', [
