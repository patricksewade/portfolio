...
- **OOP MVC & Héritage Custom** : (Archives) Factory PDO dans les Repositories, encapsulage Request immutable, pas d'echo dans les contrôleurs, et utilisation de polyfills pour les vues.
