...
class __TwigTemplate_a4421be2b16ecc921c1769dd08e68ec0 extends Template
{
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield "Portfolio d\x27Ernest Patrick SEWADE | Développeur Web Backend PHP / Symfony";
    ...
    <div class=\"flex flex-col md:flex-row items-start justify-between gap-12\">
        <div class=\"w-full md:w-2/3\">
            ...
            <p class=\"text-lg text-slate-600 mb-8 leading-relaxed max-w-2xl\">
                ";
        // line 49
        yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("profile_summary", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["profile_summary"]) || array_key_exists("profile_summary", $context) ? $context["profile_summary"] : (function () { throw new RuntimeError('Variable "profile_summary" does not exist.', 49, $this->source); })()), "Diplômé d\x27un Master 2 Architecte Digital et fort de 9 ans de pratique PHP (architecture POO, bases de données, ERP, bonnes pratiques modernes), j\x27applique aujourd\x27hui ces compétences fondamentales à l\x27écosystème Symfony. Autonome et rigoureux, je souhaite m\x27investir pleinement dans le développement, l\x27optimisation et la pérennisation de vos applications web.")) : ("Diplômé d\x27un Master 2 Architecte Digital et fort de 9 ans de pratique PHP (architecture POO, bases de données, ERP, bonnes pratiques modernes), j\x27applique aujourd\x27hui ces compétences fondamentales à l\x27écosystème Symfony. Autonome et rigoureux, je souhaite m\x27investir pleinement dans le développement, l\x27optimisation et la pérennisation de vos applications web.")), "html", null, true);
        yield "
            </p>
            ...
            <div class=\"flex justify-center w-full mb-10\">
                <div class=\"flex justify-center items-center gap-5 md:gap-8 bg-white/50 backdrop-blur-sm p-4 md:p-5 rounded-2xl border border-slate-100 shadow-sm w-fit\">
                    ...
                    <div class=\"flex flex-col items-center text-center\">
                        <span class=\"text-3xl md:text-4xl font-display font-extrabold text-slate-800\">+";
        // line 69
        yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("project_count", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["project_count"]) || array_key_exists("project_count", $context) ? $context["project_count"] : (function () { throw new RuntimeError('Variable "project_count" does not exist.', 69, $this->source); })()), 13)) : (13)), "html", null, true);
        yield "</span>
        ...
        yield "#contact\" class=\"flex items-center gap-2 px-6 py-3.5 bg-brand text-white font-display font-bold tracking-wide rounded-xl hover:bg-brand/90 transition-colors shadow-lg hover:shadow-xl hover:-translate-y-0.5 transform duration-200 text-sm sm:text-base whitespace-nowrap\">
        ...
        // line 80
        yield (string) $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_home");
        yield "#experiences\" class=\"flex items-center gap-2 px-6 py-3.5 bg-white text-slate-700 font-display font-bold tracking-wide rounded-xl border border-slate-200 hover:border-brand hover:text-brand transition-colors shadow-sm text-sm sm:text-base whitespace-nowrap\">
        ...
        yield "\" target=\"_blank\" class=\"inline-flex items-center text-sm font-semibold text-slate-500 hover:text-brand transition-colors group\">
        ...
        <div class=\"w-full md:w-1/3 flex justify-center md:justify-end\">
            <!-- Emplacement Photo de Profil (L\x27Ombre Colorée Subtile) -->
            <div class=\"relative w-64 h-64 md:w-80 md:h-80 group\">
                ...
                <div class=\"relative w-full h-full bg-white rounded-full p-1 z-10\">
                    <div class=\"w-full h-full bg-slate-100 rounded-full overflow-hidden flex items-center justify-center\">
                        <img src=\"";
        // line 121
        yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/profile.png"), "html", null, true);
        yield "\" alt=\"Ernest Patrick SEWADE\" class=\"w-full h-full object-cover\">
                    </div>
                </div>
            </div>
        </div>
...
<section id=\"competences\" class=\"mb-24 scroll-mt-24\">
    ...
    <div class=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["skills"]) || array_key_exists("skills", $context) ? $context["skills"] : (function () { throw new RuntimeError('Variable "skills" does not exist.', 144, $this->source); })()));
        foreach ($context['_seq'] as $context["category"] => $context["skill_list"]) {
            // line 145
            yield "            <div class=\"bg-slate-50/50 rounded-2xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-shadow\">
                <h3 class=\"text-lg font-extrabold text-slate-800 mb-4\">";
            // line 146
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["category"], "html", null, true);
            yield "</h3>
                <div class=\"flex flex-wrap gap-2\">
                    ";
            // line 148
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable($context["skill_list"]);
            foreach ($context['_seq'] as $context["_key"] => $context["skill"]) {
                // line 149
                yield "                        ";
                yield (string) $macros["͜macros"]->getTemplateForMacro("macro_render_skill_badge", $context, 149, $this->getSourceContext())->macro_render_skill_badge(...[$context["skill"]]);
                yield "
                    ";
            }
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['category'], $context['skill_list'], $context['_parent']);
        $context = array_intersect_key($context, $_parent);
        $context += $_parent;
        // line 154
        yield "    </div>
...
<section id=\"experiences\" class=\"mb-24 scroll-mt-24\">
    ...
    <div class=\"max-w-4xl\">
        ...
        // line 172
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["experiences"]) || array_key_exists("experiences", $context) ? $context["experiences"] : (function () { throw new RuntimeError('Variable "experiences" does not exist.', 172, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["exp"]) {
            // line 173
            yield "            ";
            yield (string) $macros["͜macros"]->getTemplateForMacro("macro_render_experience_timeline", $context, 173, $this->getSourceContext())->macro_render_experience_timeline(...[$context["exp"]]);
            yield "
        ";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_key'], $context['exp'], $context['_parent']);
        $context = array_intersect_key($context, $_parent);
        $context += $_parent;
        // line 175
        yield "    </div>
...
<section id=\"formations\" class=\"mb-24 scroll-mt-24\">
    ...
    <div class=\"max-w-4xl\">
        ...
        // line 193
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["educations"]) || array_key_exists("educations", $context) ? $context["educations"] : (function () { throw new RuntimeError('Variable "educations" does not exist.', 193, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["edu"]) {
            // line 194
            yield "            ";
            yield (string) $macros["͜macros"]->getTemplateForMacro("macro_render_education_timeline", $context, 194, $this->getSourceContext())->macro_render_education_timeline(...[$context["edu"]]);
            yield "
        ";
        }
        $_parent = $context['_parent'];
...
<section id=\"certifications\" class=\"mb-24 scroll-mt-24\">
    <div class=\"mb-10\">
        <div class=\"flex items-center gap-3 mb-3 pl-2\">
            <span class=\"w-8 h-px bg-brand opacity-80\"></span>
            <span class=\"text-brand font-bold text-sm tracking-widest uppercase opacity-80\">Mes validations d\x27acquis</span>
        </div>
        <h2 class=\"text-3xl font-extrabold text-slate-900 flex items-center\">
            <span class=\"w-2 h-8 bg-brand mr-4 rounded-full opacity-80\"></span>
    ...
    <div class=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6\">
        ...
        // line 214
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["certifications"]) || array_key_exists("certifications", $context) ? $context["certifications"] : (function () { throw new RuntimeError('Variable "certifications" does not exist.', 214, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["cert"]) {
            // line 215
            yield "            ";
            yield (string) $macros["͜macros"]->getTemplateForMacro("macro_render_certification_card", $context, 215, $this->getSourceContext())->macro_render_certification_card(...[$context["cert"]]);
            yield "
        ";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_key'], $context['cert'], $context['_parent']);
        $context = array_intersect_key($context, $_parent);
        $context += $_parent;
        // line 217
        yield "    </div>
...
<section id=\"projets\" class=\"mb-24 scroll-mt-24\">
    <div class=\"flex flex-col mb-10\">
        <div class=\"flex items-center gap-3 mb-3 pl-2\">
            ...
            <span class=\"text-accent font-bold text-sm tracking-widest uppercase opacity-80\">Ce que j\x27ai construit</span>
        </div>
        <h2 class=\"text-3xl font-extrabold text-slate-900 flex items-center\">
    ...
    <div class=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8\">
        ...
        // line 235
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["projects"]) || array_key_exists("projects", $context) ? $context["projects"] : (function () { throw new RuntimeError('Variable "projects" does not exist.', 235, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["project"]) {
            // line 236
            yield "            ";
            yield (string) $macros["͜macros"]->getTemplateForMacro("macro_render_project_card", $context, 236, $this->getSourceContext())->macro_render_project_card(...[$context["project"]]);
            yield "
        ";
        }
        $_parent = $context['_parent'];
...
<section id=\"contact\" class=\"mb-24 scroll-mt-24\">
    <div class=\"mb-10\">
        ...
        <p class=\"text-lg text-slate-600 mt-4 max-w-2xl pl-2\">Vous avez un projet ou une opportunité d\x27emploi ? Je suis disponible pour relever de nouveaux défis.</p>
    </div>
    ...
    <div class=\"max-w-3xl\">
        ...
        // line 257
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 257, $this->source); })()), "flashes", ["success"], "method", false, false, false, 257));
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 258
            yield "            <div class=\"mb-6 p-5 bg-emerald-50 text-emerald-800 rounded-2xl border border-emerald-200 shadow-sm flex items-center gap-3 animate-fade-in\">
            ...
            // line 260
            yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($context["message"]);
            yield "</span>
            </div>
        ";
        }
        ...
        // line 264
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 264, $this->source); })()), "flashes", ["error"], "method", false, false, false, 264));
        foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
            // line 265
            yield "            <div class=\"mb-6 p-5 bg-rose-50 text-rose-800 rounded-2xl border border-rose-200 shadow-sm flex items-center gap-3 animate-fade-in\">
        ...
        <div class=\"bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-200\">
            ...
            <form action=\"";
        // line 284
        yield (string) $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_contact");
        yield "\" method=\"POST\" class=\"space-y-6\">
                <input type=\"hidden\" name=\"_token\" value=\"";
        // line 285
        yield (string) $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken("contact"), "html", null, true);
        yield "\">
                ...
                <div class=\"pt-2 text-center md:text-right\">
                    <button type=\"submit\" class=\"inline-flex items-center gap-2 bg-brand text-white font-display font-bold tracking-wide rounded-xl px-10 py-4 text-base shadow-lg hover:shadow-xl hover:-translate-y-0.5 transform duration-200 hover:bg-brand/90 transition-colors w-full sm:w-auto\">
                        <svg class=\"w-5 h-5\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z\"></path></svg>
                        Envoyer le message
                    </button>
                </div>
            </form>
...
";
    ...
    {
        return array (  512 => 285,  508 => 284,  492 => 270,  482 => 267,  478 => 265,  474 => 264,  471 => 263,  461 => 260,  457 => 258,  453 => 257,  432 => 238,  422 => 236,  418 => 235,  398 => 217,  388 => 215,  384 => 214,  364 => 196,  354 => 194,  350 => 193,  330 => 175,  320 => 173,  316 => 172,  296 => 154,  287 => 151,  277 => 149,  273 => 148,  268 => 146,  265 => 145,  261 => 144,  235 => 121,  206 => 95,  188 => 80,  181 => 76,  171 => 69,  148 => 49,  104 => 7,  91 => 6,  68 => 4,  57 => 1,  55 => 2,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("{% extends \x27base.html.twig\x27 %}
{% import \x27macros.html.twig\x27 as macros %}

{% block title %}Portfolio d\x27Ernest Patrick SEWADE | Développeur Web Backend PHP / Symfony{% endblock %}
...
<section id=\"profil\" class=\"mb-24 mt-8 md:mt-16 animate-fade-in scroll-mt-24\">
    <div class=\"flex flex-col md:flex-row items-start justify-between gap-12\">
        <div class=\"w-full md:w-2/3\">
            ...
            <p class=\"text-lg text-slate-600 mb-8 leading-relaxed max-w-2xl\">
                {{ profile_summary|default(\"Diplômé d\x27un Master 2 Architecte Digital et fort de 9 ans de pratique PHP (architecture POO, bases de données, ERP, bonnes pratiques modernes), j\x27applique aujourd\x27hui ces compétences fondamentales à l\x27écosystème Symfony. Autonome et rigoureux, je souhaite m\x27investir pleinement dans le développement, l\x27optimisation et la pérennisation de vos applications web.\") }}
            </p>
            ...
            <div class=\"flex justify-center w-full mb-10\">
                <div class=\"flex justify-center items-center gap-5 md:gap-8 bg-white/50 backdrop-blur-sm p-4 md:p-5 rounded-2xl border border-slate-100 shadow-sm w-fit\">
                    ...
                    <div class=\"flex flex-col items-center text-center\">
                        <span class=\"text-3xl md:text-4xl font-display font-extrabold text-slate-800\">+{{ project_count|default(13) }}</span>
                        <span class=\"text-[10px] md:text-xs text-slate-500 font-semibold mt-1 uppercase tracking-wider\">Projets<br>réalisés</span>
                    </div>
                </div>
            </div>
            ...
            <div class=\"flex flex-wrap items-center gap-3 mb-6\">
                <a href=\"{{ path(\x27app_home\x27) }}#contact\" class=\"flex items-center gap-2 px-6 py-3.5 bg-brand text-white font-display font-bold tracking-wide rounded-xl hover:bg-brand/90 transition-colors shadow-lg hover:shadow-xl hover:-translate-y-0.5 transform duration-200 text-sm sm:text-base whitespace-nowrap\">
                    <svg class=\"w-5 h-5\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z\"></path></svg>
                    Me contacter
                </a>
                <a href=\"{{ path(\x27app_home\x27) }}#experiences\" class=\"flex items-center gap-2 px-6 py-3.5 bg-white text-slate-700 font-display font-bold tracking-wide rounded-xl border border-slate-200 hover:border-brand hover:text-brand transition-colors shadow-sm text-sm sm:text-base whitespace-nowrap\">
                    <svg class=\"w-5 h-5\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z\"></path></svg>
                    Voir mon parcours
                </a>
                <div class=\"flex items-center text-xs sm:text-sm font-bold text-emerald-700 bg-emerald-50 px-4 py-3.5 rounded-xl border border-emerald-100 shadow-sm whitespace-nowrap\">
            ...
            <!-- Liens Secondaires : CV & Social -->
            <div class=\"flex items-center gap-6 mb-10 sm:pl-2\">
                <a href=\"{{ asset(\x27docs/CV_Ernest_Patrick_SEWADE.pdf\x27) }}\" target=\"_blank\" class=\"inline-flex items-center text-sm font-semibold text-slate-500 hover:text-brand transition-colors group\">
                    <span class=\"bg-slate-100 p-2 rounded-lg mr-3 group-hover:bg-brand/10 group-hover:-translate-y-0.5 transition-all duration-300 shadow-sm\">
                        <svg class=\"w-4 h-4 text-slate-600 group-hover:text-brand transition-colors\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4\"></path></svg>
                    </span>
                    Télécharger mon CV (PDF)
        ...
        <div class=\"w-full md:w-1/3 flex justify-center md:justify-end\">
            ...
            <div class=\"relative w-64 h-64 md:w-80 md:h-80 group\">
                ...
                <div class=\"relative w-full h-full bg-white rounded-full p-1 z-10\">
                    <div class=\"w-full h-full bg-slate-100 rounded-full overflow-hidden flex items-center justify-center\">
                        <img src=\"{{ asset(\x27images/profile.png\x27) }}\" alt=\"Ernest Patrick SEWADE\" class=\"w-full h-full object-cover\">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6\">
        {% for category, skill_list in skills %}
            <div class=\"bg-slate-50/50 rounded-2xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-shadow\">
                <h3 class=\"text-lg font-extrabold text-slate-800 mb-4\">{{ category }}</h3>
                <div class=\"flex flex-wrap gap-2\">
                    {% for skill in skill_list %}
                        {{ macros.render_skill_badge(skill) }}
                    {% endfor %}
                </div>
            </div>
        {% endfor %}
...
<section id=\"experiences\" class=\"mb-24 scroll-mt-24\">
    ...
    <div class=\"max-w-4xl\">
        {% for exp in experiences %}
            {{ macros.render_experience_timeline(exp) }}
        {% endfor %}
    </div>
</section>
...
<section id=\"formations\" class=\"mb-24 scroll-mt-24\">
    ...
    <div class=\"max-w-4xl\">
        {% for edu in educations %}
            {{ macros.render_education_timeline(edu) }}
        {% endfor %}
    </div>
</section>
...
<section id=\"certifications\" class=\"mb-24 scroll-mt-24\">
    ...
    <div class=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6\">
        {% for cert in certifications %}
            {{ macros.render_certification_card(cert) }}
        {% endfor %}
    </div>
</section>
...
<section id=\"projets\" class=\"mb-24 scroll-mt-24\">
    ...
    <div class=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8\">
        {% for project in projects %}
            {{ macros.render_project_card(project) }}
        {% endfor %}
    </div>
</section>
    ...
    <div class=\"max-w-3xl\">
        {% for message in app.flashes(\x27success\x27) %}
            <div class=\"mb-6 p-5 bg-emerald-50 text-emerald-800 rounded-2xl border border-emerald-200 shadow-sm flex items-center gap-3 animate-fade-in\">
                <svg class=\"w-6 h-6 text-emerald-600 flex-shrink-0\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z\"></path></svg>
                <span class=\"font-medium\">{{ message|escape }}</span>
            </div>
        {% endfor %}
        ...
        <div class=\"bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-200\">
            ...
            <form action=\"{{ path(\x27app_contact\x27) }}\" method=\"POST\" class=\"space-y-6\">
                <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token(\x27contact\x27) }}\">
...
{% endblock %}
", "pages/home.html.twig", "C:\\wamp64\\www\\portfolio\\templates\\pages\\home.html.twig");
    }
}
