...
class getCache_AppClearerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['cache.app_clearer'] = new \Symfony\Component\HttpKernel\CacheClearer\Psr6CacheClearer(['cache.app' => ($container->services['cache.app'] ?? self::getCache_AppService($container)), 'cache.http_client.pool' => ($container->services['cache.http_client.pool'] ?? self::getCache_HttpClient_PoolService($container)), 'cache.rate_limiter' => ($container->services['cache.rate_limiter'] ?? self::getCache_RateLimiterService($container))]);
    }
}
