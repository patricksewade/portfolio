...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            '.tailwind.command.build' => ['privates', '..tailwind.command.build.lazy', 'get__Tailwind_Command_Build_LazyService', true],
            '.tailwind.command.init' => ['privates', '..tailwind.command.init.lazy', 'get__Tailwind_Command_Init_LazyService', true],
            '.tailwind.command.update' => ['privates', '..tailwind.command.update.lazy', 'get__Tailwind_Command_Update_LazyService', true],
