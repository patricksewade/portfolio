...
class getCache_HttpClient_PoolService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('cd3GCSOfuW', 0, (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));

        $instance->setLogger(($container->privates['logger'] ?? self::getLoggerService($container)));

        return $container->services['cache.http_client.pool'] = $instance;
    }
}
